...
{
$did = $_REQUEST['did'];
$del = mysqli_query($conn,"delete from categories where id='".$did."'") or die(mysqli_error($conn));
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				while($c=mysqli_fetch_array($get))
				{
					...
					<td><a href="list_category.php?did=<?php echo $c['id'];?>"><i class="fa fa-trash"></i></a></td>
					</tr>
					<?php
					$i++;
