...
<div class="cart_main">
	 <div class="container">
		 ...
		 <?php  
		 $i=1;
		 $ord = mysqli_query($conn,"select * from orders where user_id='".$_SESSION['user_id']."'") or die(mysqli_error($conn));
		 ...
		 <td><a href="invoice.php?inv=<?php echo $order['id'];?>">Invoice</a></td>
		 <?php $i++; } ?>
		 </table>
